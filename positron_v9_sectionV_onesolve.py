...
fenow=1.1e5
sol1=find_solution(NVal=64e6,T_e=54,fE=fenow,mur2=0.00126,B=2.0, #0.00145
                   electrodeConfig=(electrode_voltages,electrode_borders),
                   left=Llim,right=Rlim,zpoints=200,rpoints=100,rfact=3.0,plotting=True)
...
save2.to_csv('~/Documents/gnuplot/plasma2024/pots/positron2D_pots',index=False,index_label=False,header=False)
save3.to_csv('~/Documents/gnuplot/plasma2024/pots/positron2D_freespace',index=False,index_label=False,header=False)
