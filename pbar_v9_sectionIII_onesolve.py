...
fenow=5.7e4  
sol1=find_solution(NVal=3.1e6,T_e=1700,fE=fenow,mur2=0.00114,B=1.6,
                   electrodeConfig=(electrode_voltages,electrode_borders),
                   left=Llim,right=Rlim,zpoints=100,rpoints=100,rfact=3.0,plotting=True)
...
save=pd.DataFrame(n)
#save.to_csv('~/Documents/gnuplot/plasma2024/profiles/pbar2D',index=False,index_label=False,header=False)
#%%
save2=pd.DataFrame(sol1[6])
save3=pd.DataFrame(sol1[4])
save2.to_csv('~/Documents/gnuplot/plasma2024/profiles/pbar2D_pots',index=False,index_label=False,header=False)
save3.to_csv('~/Documents/gnuplot/plasma2024/profiles/pbar2D_freespace',index=False,index_label=False,header=False)