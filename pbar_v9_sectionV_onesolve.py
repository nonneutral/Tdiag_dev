...
fenow=4.15e4
sol1=find_solution(NVal=1.8e6,T_e=720,fE=fenow,mur2=0.00126,B=1.6,
...
save2.to_csv('~/Documents/gnuplot/plasma2024/pots/pbar2D_pots',index=False,index_label=False,header=False)
save3.to_csv('~/Documents/gnuplot/plasma2024/pots/pbar2D_freespace',index=False,index_label=False,header=False)